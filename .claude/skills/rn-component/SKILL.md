---
name: rn-component
description: Creates React Native components following ENAPO's Liquid Glass design system with TypeScript, tokens, and state management patterns. Use when building any new UI component.
---
When creating React Native components for ENAPO:
